...
class DefaultFormView(DefaultModelCoreViewMixin, FormView):
    ...
    def get_buttons_dict(self):
            return {'save': {'label': self.get_save_button_label(), 'title': self.get_save_button_title()}}

    def get_save_button_title(self):
        return self.save_button_title

    def get_save_button_label(self):
        return self.save_button_label
...
class DefaultCoreModelFormView(ListParentMixin, DefaultModelFormView):
    ...
    def get_buttons_dict(self):
        ...
        buttons_dict.update({'save_and_continue': {'label': self.get_save_and_continue_button_label(),
                                                   'title': self.get_save_and_continue_button_title()},
                             'cancel': {'label': self.get_cancel_button_label(),
                                        'title': self.get_cancel_button_title()}})
        return buttons_dict

    def get_save_and_continue_button_title(self):
        return self.save_and_continue_button_title

    def get_save_and_continue_button_label(self):
        return self.save_and_continue_button_label

    def get_cancel_button_title(self):
        return self.cancel_button_title

    def get_cancel_button_label(self):
        return self.cancel_button_label
